...
WebUI.click(findTestObject('Trade/Page_Vonix (development)/span_Automata Network'))

WebUI.setText(findTestObject('Trade/Page_Vonix (development)/input'), input_AUTOMATANETWORK)
