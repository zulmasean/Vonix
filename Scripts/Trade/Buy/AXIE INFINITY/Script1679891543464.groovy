...
WebUI.click(findTestObject('Trade/Page_Vonix (development)/span_Axie Infinity'))

WebUI.setText(findTestObject('Trade/Page_Vonix (development)/input'), input_AXIEINFINITY)
