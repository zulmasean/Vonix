...
WebUI.click(findTestObject('Trade/Page_Vonix (development)/span_Alpha Venture DAO'))

WebUI.setText(findTestObject('Trade/Page_Vonix (development)/input'), input_ALPHAVENTURE)
