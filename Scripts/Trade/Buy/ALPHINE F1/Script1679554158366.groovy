...
WebUI.click(findTestObject('Trade/Page_Vonix (development)/span_Alpine F1 Team Fan Token'))

WebUI.setText(findTestObject('Trade/Page_Vonix (development)/input'), input_ALPHINE)
