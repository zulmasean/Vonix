...
WebUI.click(findTestObject('Trade/Page_Vonix (development)/span_Ampleforth'))

WebUI.setText(findTestObject('Trade/Page_Vonix (development)/input'), input_AMPLEFORTH)
