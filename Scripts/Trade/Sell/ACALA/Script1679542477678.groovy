...
WebUI.click(findTestObject('Trade/Sell/Page_Vonix (development)/span_Acala Token'))

WebUI.click(findTestObject('Trade/Sell/Page_Vonix (development)/p_Acala Token ACA  USDT'))
